...
#
# This script:
#   1. Compares 1kGP-panel-phased SR variants against
...
#
# Usage:
#   bash 01.sr_error_rate_whatshap_evaluation.sh \
#       chr1 \
#       SAMPLE_ID
#
###############################################################################
...
DATA_VCF=${DATA_DIR}/${CHR}/isec/0000.bcf
...
whatshap compare \
    --sample ${SAMPLE} \
    --switch-error-bed ${OUTDIR}/${SAMPLE}.overlap.ngs.1kgp.ser.bed \
    --longest-block-tsv ${OUTDIR}/${SAMPLE}.overlap.ngs.1kgp.longest-block.tsv \
    --tsv-pairwise ${OUTDIR}/${SAMPLE}.overlap.ngs.1kgp.pairwise.tsv \
    ${BENCHMARK_VCF} \
    ${DATA_VCF}
