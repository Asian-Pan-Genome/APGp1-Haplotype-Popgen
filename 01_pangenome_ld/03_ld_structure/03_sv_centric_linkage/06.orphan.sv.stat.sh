...
# Annotate orphan SVs in difficult/easy regions
...
echo -e "r2\ttotal\tgiab_diff\tgiab_easy\tt2tmask_diff\tt2tmask_easy\tpanmask_diff\tpanmask_easy"

for r2 in 0.2 0.4; do

    FILE="sv.orphan.${r2}.1000000k.tsv"
    ...
    echo -e "${r2}\t${TOTAL}\t${GIAB_DIFF}\t$((TOTAL-GIAB_DIFF))\t${T2T_DIFF}\t$((TOTAL-T2T_DIFF))\t${PAN_DIFF}\t$((TOTAL-PAN_DIFF))"
